...
export const companyLogos = [dell, siriraj, nbtc];
...
export const roadmap = [
  {
    id: "0",
    title: "Chest X-Ray",
    text: "Able to indentify 10 different issues located within the chest region.",
    date: "May 2023",
    status: "done",
    imageUrl: roadmap1,
    colorful: true,
  },
  {
    id: "1",
    title: "CT Brain",
    text: "Allow users to read Head X-Ray scan in seconds.",
    date: "May 2023",
    status: "done",
    imageUrl: roadmap2,
    colorful: true,
  ...
  {
    id: "2",
    title: "Bony Destruction",
    text: "Working on different areas of the body.",
    date: "May 2023",
    status: "progress",
    imageUrl: roadmap3,
  },
  {
    id: "3",
    title: "Hip Fractures",
    text: "Working on increasing the yield of the AI in charge of indetifying problems in the hip area.",
    date: "May 2023",
    status: "progress",
    imageUrl: roadmap4,
  },
